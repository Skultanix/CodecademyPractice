...
/* 1. Let’s practice adding some code comments.
    ...
    On line 1 (17), write a single line comment that says Opening line.*/
...
//4/10
// 1. On line 1 (35), log the string 'JavaScript' to the console.
console.log(`JavaScript`);
// 2. On line 2 (37), log the number 2011 to the console.
console.log(2011);
// 3. On line 3 (38), print 'Woohoo! I love to code! #codecademy' to the console.
console.log(`Woohoo! I love to code! #codecademy`);
// 4.On line 4 (41), print the number 20.49 to the console.
console.log(20.49);
